...
const DotField = memo(({
  ...
  // Use React's useId to ensure a stable ID between server and client during hydration
  const reactId = useId();
  ...
  useEffect(() => {
    ...
    function onMouseMove(e: MouseEvent | TouchEvent) {
      ...
      mouseRef.current.x = clientX + window.scrollX - s.offsetX;
      mouseRef.current.y = clientY + window.scrollY - s.offsetY;
    }
    ...
    window.addEventListener('touchstart', (e) => onMouseMove(e as unknown as TouchEvent), { passive: true });
    window.addEventListener('touchmove', (e) => onMouseMove(e as unknown as TouchEvent), { passive: true });
